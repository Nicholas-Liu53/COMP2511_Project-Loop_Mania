...
public class LoopManiaWorld {
    ...
    // // TODO = modify this - currently the character automatically wins all
    // battles without any damage!
    // List<Enemy> defeatedEnemies = new ArrayList<Enemy>();
    // for (Enemy e: enemies){
    // // Pythagoras: a^2+b^2 < radius^2 to see if within radius
    // // TODO = you should implement different RHS on this inequality, based on
    // influence radii and battle radii
    // if (Math.pow((character.getX()-e.getX()), 2) +
    // Math.pow((character.getY()-e.getY()), 2) < 4){
    // // fight...
